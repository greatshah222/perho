	...
	useEffect(() => {
		...
		if (props.token && props.itemId) {
			...
			const createScript = () => {
				...
				radiantscript.src = "https://cdn.radiantmediatechs.com/rmp/6.4.11/js/rmp.min.js";
			...
			window._icareus.streamRootKeysUrl = "/d15n7gkgywbuz.cloudfront.net/suite/streamrootkeys.json";
			...
			const backCustomModule = {
				...
				svgHover: "https://www.kirjastokino.fi/on-demand-player-portlet/images/button_back.svg", // TODO: Image from /images, not web url
